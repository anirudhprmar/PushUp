  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-0 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-gradient-1/20 to-gradient-2/20 blur-[120px] translate-x-1/3" />
        <div className="absolute top-1/2 right-1/4 w-[400px] h-[400px] rounded-full bg-gradient-to-br from-gradient-2/15 to-gradient-1/15 blur-[100px]" />
        <div className="absolute bottom-1/4 right-1/3 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-gradient-1/10 to-gradient-2/10 blur-[110px]" />
      </div>

      {/* Navigation */}
      <nav className="relative border-b border-border/50 sticky top-0 z-50 backdrop-blur-glass bg-background/80">
